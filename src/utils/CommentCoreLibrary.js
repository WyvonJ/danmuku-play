...
export var CommentManager = (function () {
  ...
  CommentManager.prototype.time = function (time) {
    ...
    for (; this.position < this.timeline.length; this.position++) {
      if (this.timeline[this.position]['stime'] <= time) {
        if (this.options.limit > 0 && this.runline.length + batch.length >= this.options.limit) {
  ...
  CommentManager.prototype.send = function (data) {
    ...
    data = data.map(this._preprocess.bind(this)).filter(function (item) {
      return item !== null;
    });
    if (data.length === 0) {
      return;
...
export var CoreComment = (function () {
...
export var ScrollComment = (function (_super) {
...
export var CommentFactory = (function () {
...
export var CommentSpaceAllocator = (function () {
...
export var AnchorCommentSpaceAllocator = (function (_super) {
...
export var CssCompatLayer = (function () {
...
export var CssScrollComment = (function (_super) {
 ...
 * @author Jim Chen
 */
export var CommentFilter = (function () {
  /**
  ...
  CommentFilter.prototype.doValidate = function (cmtData) {
    ...
    if (
      (!this.allowUnknownTypes || cmtData.mode.toString() in this.allowTypes) &&
...
export var CommentProvider = (function () {
  ...
  CommentProvider.prototype.load = function () {
    ...
    for (var type in this._staticSources) {
      promises.push(
        Promises.any(this._staticSources[type]).then(
          function (data) {
    ...
    return Promises.any(promises).then(
    ...
    return this.load().then(
      function (commentList) {
        ...
        for (var type in this._dynamicSources) {
          this._dynamicSources[type].forEach(
            function (source) {
